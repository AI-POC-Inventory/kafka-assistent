...
async def get_agent_async():
  ...
  root_agent = LlmAgent(
      ...
      instruction="""
            ...
            Extract the relevant information from the user query to determine which tool to use and what parameters to pass.
...
async def async_main():
  ...
  query = "please create a topic test_from_agent_4 with partition 40 and replication factor 1"
